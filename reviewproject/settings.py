...
from django.conf.global_settings import LOGIN_URL, MEDIA_ROOT, MEDIA_URL, STATICFILES_DIRS, STATIC_ROOT
...
SECRET_KEY = 'qalm+snkaqlh6d1t6a-k4p3ol=4l%^(d+m_q_cgo$)(cnl)rdp'
